...
public class CheckoutActivity extends AppCompatActivity {
    ...
    private boolean validateForm() {
        ...
        btnContinue.setBackgroundColor(isValid ?
                ContextCompat.getColor(this, R.color.colorPrimary) :
                ContextCompat.getColor(this, R.color.disabled_gray));
    ...
    private void loadIntentData() {
        ...
        if (intent != null) {
            ...
            selectedPromotion = (Promotion) intent.getSerializableExtra("selectedPromotion");

            // Get selected items from intent extras instead of currentCart
            selectedCartItems = intent.getParcelableArrayListExtra("selectedItems");
    ...
    private void calculateOrderSummary() {
        ...
        if (selectedPromotion != null) {
            if ("percentage".equals(selectedPromotion.getDiscounttype())) {
                discount = subtotal * (selectedPromotion.getDiscountvalue() / 100.0);
            } else {
